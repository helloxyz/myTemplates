...
function onMessage(e) {
    ...
    if (array.event == 'pong') {
        ...
        } else if (channel === 'ok_sub_futureusd_btc_ticker_this_week') {
            $(document).trigger('ticker-this-week', data)
        } else if (channel === 'ok_sub_futureusd_btc_ticker_next_week') {
            $(document).trigger('ticker-next-week', data)
